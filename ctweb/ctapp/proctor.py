...
face_cascade = cv2.CascadeClassifier(
    'C:/Users/rahul/OneDrive/Documents/new mega project files/cascades/data/haarcascade_frontalface_alt.xml')
    ...
    if len(faces) == 0:
        ...
        if cheating > 0:
            if (datetime.datetime.now().second - now) > 10:
                print("CHEATING", datetime.datetime.now().hour, ":", datetime.datetime.now().minute, ":",
